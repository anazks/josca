...
export default function FloatingWhatsApp() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-6 right-6 z-[9980] bg-emerald-500 hover:bg-emerald-400 text-white p-4 rounded-full shadow-2xl shadow-emerald-500/40 flex items-center justify-center group focus:outline-none border-2 border-emerald-300/30"
